...
function UnderConstruction() {
  return (
    <div className="font-['Rye'] bg-black text-white min-h-screen flex flex-col items-center justify-center text-center px-6">
      <div className="text-red-600 text-8xl font-black uppercase">KK</div>
      <h1 className="text-4xl font-black uppercase mt-4">
        Under <span className="text-yellow-500">Kreative</span> Konstruction
      </h1>
