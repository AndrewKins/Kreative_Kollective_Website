  ...
  return (
    <footer className=" font-['Rye'] bg-black text-white py-10 px-6 md:px-12">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        {/* Col 1 — Contact Us */}
        <div>
          <h3 className="text-yellow-500 font-black uppercase text-sm tracking-wider mb-4">
            Contact Us
          </h3>
          ...
          <div className="flex items-center gap-3 mt-5">
            <a
              href="https://www.instagram.com/kreativekollectivenyc/"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://www.youtube.com/@KreativeKollectivenyc"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://www.tiktok.com/@kreativekollectivenyc?lang=en"
              target="_blank"
              rel="noreferrer"
            >
        ...
        <div>
          ...
          <p className="text-gray-300 text-sm leading-relaxed">
            Follow us on social media and stay updated on events, performances,
            and more!
          </p>
        </div>
